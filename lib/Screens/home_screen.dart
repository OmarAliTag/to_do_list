                                ...
                                onTap: () {
                                  showDialog(
                                    ...
                                    builder: (context) {
                                      return AlertDialog(
                                        title: Text(
                                          'Archive ${filterNotes[index]
                                              .title} Note',
                                          style: GoogleFonts.lato(),
                                        ),
                                        content: Text(
                                          'Are you sure want to archive this note ?',
                                          style: GoogleFonts.lato(),
                                        ),
                                        actions: [
                                          TextButton(
                                          ...
                                          TextButton(
                                            onPressed: () {
                                              setState(() {
                                                MyDatabase.archiveNote(
                                                    id: filterNotes[index].id);
                                                filterNotes[index].archive = true;
                                                Navigator.pop(context);
                                              });
                                            },
                                            child: Text('Yes'),
              ...
              child: Column(
                ...
                children: [
                  ...
                  ElevatedButton(
                    ...
                    child: Text('View Archived Notes'),
                  ),
